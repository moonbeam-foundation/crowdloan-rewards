...
//! DATE: 2021-07-12, STEPS: `[32, ]`, REPEAT: 32, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn initialize_reward_vec(x: u32, _y: u32, ) -> Weight {
		(22_062_914_000 as Weight)
			// Standard Error: 367_000
			.saturating_add((42_980_000 as Weight).saturating_mul(x as Weight))
			.saturating_add(T::DbWeight::get().reads(890 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(x as Weight)))
			.saturating_add(T::DbWeight::get().writes(1326 as Weight))
...
impl WeightInfo for () {
	fn initialize_reward_vec(x: u32, _y: u32, ) -> Weight {
		(22_062_914_000 as Weight)
			// Standard Error: 367_000
			.saturating_add((42_980_000 as Weight).saturating_mul(x as Weight))
			.saturating_add(RocksDbWeight::get().reads(890 as Weight))
			.saturating_add(RocksDbWeight::get().reads((2 as Weight).saturating_mul(x as Weight)))
			.saturating_add(RocksDbWeight::get().writes(1326 as Weight))
